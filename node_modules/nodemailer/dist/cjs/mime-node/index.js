...
const index_js_1 = __importDefault(require("../addressparser/index.js"));
const index_js_2 = __importDefault(require("../fetch/index.js"));
const errors = __importStar(require("../errors.js"));
const last_newline_js_1 = __importDefault(require("./last-newline.js"));
const le_windows_js_1 = __importDefault(require("./le-windows.js"));
const le_unix_js_1 = __importDefault(require("./le-unix.js"));
...
class MimeNode {
        ...
        this._headers.forEach(header => {
            ...
            switch (header.key) {
                ...
                case 'Content-Type':
                    ...
                    if (structured.value.match(/^text\/plain\b/) &&
    ...
    _generateMessageId() {
        return ('<' +
            ...
            (prev, len) => prev + '-' + node_crypto_1.default.randomBytes(len).toString('hex'), node_crypto_1.default.randomBytes(4).toString('hex')) +
            '@' +
